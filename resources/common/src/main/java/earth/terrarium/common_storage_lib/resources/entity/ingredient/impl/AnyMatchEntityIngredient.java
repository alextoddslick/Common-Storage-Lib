...
public record AnyMatchEntityIngredient(List<EntityIngredient> children) implements ListEntityIngredient {
    ...
    public static final EntityIngredientType<AnyMatchEntityIngredient> TYPE = new EntityIngredientType<>(Identifier.fromNamespaceAndPath(ResourceLib.MOD_ID, "any_match"), CODEC);
