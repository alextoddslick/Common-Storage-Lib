...
public class CommonTags {
    ...
    public static class Items {
         ...
         * If checking for the fluid this bucket holds in code, please use FluidApi instead.
         */
        ...
        public static final TagKey<Item> DYES_BLACK = dyes(DyeColor.BLACK);
        public static final TagKey<Item> DYES_RED = dyes(DyeColor.RED);
        public static final TagKey<Item> DYES_GREEN = dyes(DyeColor.GREEN);
        public static final TagKey<Item> DYES_BROWN = dyes(DyeColor.BROWN);
        public static final TagKey<Item> DYES_BLUE = dyes(DyeColor.BLUE);
        public static final TagKey<Item> DYES_PURPLE = dyes(DyeColor.PURPLE);
        public static final TagKey<Item> DYES_CYAN = dyes(DyeColor.CYAN);
        public static final TagKey<Item> DYES_LIGHT_GRAY = dyes(DyeColor.LIGHT_GRAY);
        public static final TagKey<Item> DYES_GRAY = dyes(DyeColor.GRAY);
        public static final TagKey<Item> DYES_PINK = dyes(DyeColor.PINK);
        public static final TagKey<Item> DYES_LIME = dyes(DyeColor.LIME);
        public static final TagKey<Item> DYES_YELLOW = dyes(DyeColor.YELLOW);
        public static final TagKey<Item> DYES_LIGHT_BLUE = dyes(DyeColor.LIGHT_BLUE);
        public static final TagKey<Item> DYES_MAGENTA = dyes(DyeColor.MAGENTA);
        public static final TagKey<Item> DYES_ORANGE = dyes(DyeColor.ORANGE);
        public static final TagKey<Item> DYES_WHITE = dyes(DyeColor.WHITE);
        ...
        private static TagKey<Item> dyes(DyeColor color) {
            return tag("dyes/" + color.getName());
        }
    }
