...
public class FabricItemApiEntityAutomationLookup extends FabricEntityContainerLookup<ItemContainer, Direction> {
    ...
    public FabricItemApiEntityAutomationLookup() {
        super(ResourceLocation.fromNamespaceAndPath(Botarium.MOD_ID, "entity_automation"), ItemContainer.class,
                Direction.class);
    }

    @Override
    public void registerEntityTypes(EntityGetter<ItemContainer, Direction> getter,
            Supplier<EntityType<?>>... containers) {
